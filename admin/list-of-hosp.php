    ...
    <div class="container" style="display: flex;">
        <div class="sidebar">
            <ul>
                ...
                <a href="../admin/list-of-hosp.php"><li class="active">List of hospitals</li></a>
        ...
        <div class="main-content">
                <div class="container6">
                    <h1>Hospital Approval Status</h1>
            
                    <!-- Approved Hospitals Table -->
                    <h2 style="color: rgb(0, 140, 255); margin-bottom:0.5em;">Approved Hospitals</h2>
                    <div class="table-responsive approved-table">
                        <table>
                            ...
                            <tbody>
                                <?php
                                        $approved_query = "SELECT * FROM users WHERE role = 'Hospital' AND action = 'Approved' ";
                                        $approved_res = mysqli_query($conn,$approved_query);
                                        if($approved_res && mysqli_num_rows($approved_res) > 0){
                                            ...
                                            echo "<tr><td colspan='5'>No Aprroved Hospitals Found</td></tr>";
                                        }
                                ?>
                            </tbody>
                        </table>
                    ...
                    <h2 style="color: red; margin-bottom:0.5em; margin-top:0.5em;">Not Approved Hospitals</h2>
                    <div class="table-responsive not-approved-table">
                        <table>
                            ...
                            <tbody>
                                <?php
                                        $reject_query = "SELECT * FROM users WHERE role = 'Hospital' AND action = 'Reject' ";
                                        $reject_res = mysqli_query($conn,$reject_query);
                                        if($reject_res && mysqli_num_rows($reject_res)>0){
                                            ...
                                            echo "<tr><td colspan='5'>No Rejected Hospitals Found</td></tr>";
                                        }
